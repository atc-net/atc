...
{
    /// <summary>
    /// The footer text appended to generated markdown documentation files.
    /// </summary>
    internal const string GeneratedBy = "<hr /><div style='text-align: right'><i>Generated by MarkdownCodeDoc version 1.2</i></div>";

    /// <summary>
    /// Generates markdown documentation files for all public types in the specified assembly.
    /// </summary>
