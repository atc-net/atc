...
public abstract class ContentResultAssertionsBase<TAssertions> : ReferenceTypeAssertions<ContentResult, ContentResultAssertionsBase<TAssertions>>
{
    ...
    protected ContentResultAssertionsBase(
        ...
        params object[] becauseArgs)
    {
        ...
        using (var scope = new AssertionScope($"content of {Identifier}"))
        {
            ...
            if (error is not null)
            {
                ...
                CurrentAssertionChain.FailWith(fixedErrorMessage);
            }
        }
        ...
        params object[] becauseArgs)
    {
        ...
        // Its safe to ! BANG the result variable as the previous CurrentAssertionChain will throw if
        // result is null and the parsing failed.
        return new AndWhichConstraint<ObjectAssertions, T>(new ObjectAssertions(result, CurrentAssertionChain), result!);
    }
