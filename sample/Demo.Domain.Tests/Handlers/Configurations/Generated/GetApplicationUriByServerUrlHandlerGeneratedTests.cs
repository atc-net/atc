...
namespace Demo.Domain.Api.Generated.Handlers.Tests
{
    ...
    public class GetApplicationUriByServerUrlHandlerGeneratedTests
    {
        [Fact]
        public void InstantiateConstructor()
        {
            // Act
            var actual = new GetApplicationUriByServerUrlHandler();
        ...
        {
            // Arrange
            var sut = new GetApplicationUriByServerUrlHandler();
