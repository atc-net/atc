...
namespace Demo.Api.Generated.Contracts.Accounts
{
    ...
    public class UpdateAccountNameResult
    {
        ...
        /// </summary>
        public static UpdateAccountNameResult BadRequest(string message) => new UpdateAccountNameResult(ResultFactory.CreateContentResultWithProblemDetails(HttpStatusCode.BadRequest, message));
