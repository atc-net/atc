...
namespace Demo.Api.Generated.Contracts.Accounts
{
    ...
    public class SetAccountNameResult
    {
        ...
        /// </summary>
        public static SetAccountNameResult BadRequest(string message) => new SetAccountNameResult(ResultFactory.CreateContentResultWithProblemDetails(HttpStatusCode.BadRequest, message));
