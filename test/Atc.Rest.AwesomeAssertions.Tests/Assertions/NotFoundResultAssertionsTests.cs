...
public class NotFoundResultAssertionsTests : ContentResultAssertionsBaseFixture
{
    ...
    public void Ctor_Sets_Subject_On_Subject_Property()
    {
        ...
        // Act
        var sut = new NotFoundResultAssertions(expected, AssertionChain.GetOrCreate());
    ...
    [Theory]
    [InlineData("BAR", @"Expected content of not found result to be string, but found System.Text.Json.JsonElement.")]
    [InlineData(42, @"Expected content of not found result to be 42, but found FOO.")]
        ...
        string expectedMessage)
    {
        ...
        var sut = new NotFoundResultAssertions(target, AssertionChain.GetOrCreate());
    ...
    public void WithContent_Throws_When_Content_Is_Not_Equivalent_To_Expected_WithBecauseMessage()
    {
        ...
        sut
            ...
            .Should()
            .Throw<XunitException>()
            .WithMessage(@"Expected content of not found result to be the same string Because of something, but they differ at index 0:" + "*");
    }
    ...
    public void WithContent_Throws_When_ContentTypes_Isnt_Json()
    {
        ...
        sut
            ...
            .Should()
            .Throw<XunitException>()
            .WithMessage(@"Expected content type of not found result to be ""application/json"", but found ""BAZ"".");
    }
        ...
        object content)
    {
        ...
        sut
            ...
            .Should()
            .Throw<XunitException>()
            .WithMessage(@"Expected error message of not found result to be ""BAR"", but found ""FOO"".");
    }
