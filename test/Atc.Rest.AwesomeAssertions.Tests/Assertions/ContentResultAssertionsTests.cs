namespace Atc.Rest.AwesomeAssertions.Tests.Assertions;
...
public class ContentResultAssertionsTests : ContentResultAssertionsBaseFixture
{
    ...
    public void Ctor_Sets_Subject_On_Subject_Property()
    {
        ...
        // Act
        var sut = new ContentResultAssertions(expected, AssertionChain.GetOrCreate());
    ...
    [Theory]
    [InlineData("BAR", @"Expected content of content result to be string, but found System.Text.Json.JsonElement.")]
        ...
        string expectedMessage)
    {
        ...
        var sut = new ContentResultAssertions(target, AssertionChain.GetOrCreate());
    ...
    public void WithContent_Throws_When_Content_Is_Not_Equivalent_To_Expected_WithBecauseMessage()
    {
        ...
        sut
            ...
            .Should()
            .Throw<XunitException>()
            .WithMessage(@"Expected content of content result to be the same string Because of something, but they differ at index 0:" + "*");
    }
    ...
    public void WithStatusCode_Throws_When_StatusCode_Is_Not_As_Expected()
    {
        ...
        // Each assertion uses its own assertions instance, mirroring real usage where every
        // result.Should() call produces a fresh AssertionChain (a chain only reports a failure once).
        new ContentResultAssertions(target, AssertionChain.GetOrCreate())
    ...
    public void WithContentOfType_Throws_When_Content_Is_Not_Expected_Type_With_BecauseMessage()
    {
        ...
        sut
            ...
            .Should()
            .Throw<XunitException>()
            .WithMessage(@"Expected type of content in content result to be int Because of something, but found """"FOO"""".");
    }
