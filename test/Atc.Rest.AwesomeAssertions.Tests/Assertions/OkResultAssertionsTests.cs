...
public class OkResultAssertionsTests
{
    ...
    public void Ctor_Sets_Subject_On_Subject_Property()
    {
        ...
        // Act
        var sut = new OkResultAssertions(expected, AssertionChain.GetOrCreate());
    ...
    [Theory]
    [InlineData("BAR", @"Expected content of OK result to be the same string, but they differ at index 0:")]
        ...
        string expectedMessage)
    {
        ...
        var sut = new OkResultAssertions(target, AssertionChain.GetOrCreate());
    ...
    public void WithContent_Throws_When_Content_Is_Not_Equivalent_To_Expected_WithBecauseMessage()
    {
        ...
        sut
            ...
            .Should()
            .Throw<XunitException>()
            .WithMessage(@"Expected content of OK result to be the same string Because of something, but they differ at index 0:" + "*");
    }
    ...
    public void WithContentOfType_Throws_When_Content_Is_Not_Expected_Type_With_BecauseMessage()
    {
        ...
        sut
            ...
            .Should()
            .Throw<XunitException>()
            .WithMessage(@"Expected content type of OK result*to be assignable to System.Collections.Generic.List<string> Because of something, but string is not.");
    }
