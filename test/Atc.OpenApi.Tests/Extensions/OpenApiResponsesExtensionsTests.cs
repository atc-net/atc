...
public class OpenApiResponsesExtensionsTests
{
    ...
    public void GetSchemaForStatusCode(
    ...
    public void GetSchemaForStatusCode_ContentType(
        OpenApiSchema expected,
        OpenApiResponses openApiResponses,
        HttpStatusCode httpStatusCode,
        string contentType)
    ...
    public void GetModelNameForStatusCode(
        string expected,
        OpenApiResponses openApiResponses,
        HttpStatusCode httpStatusCode)
    {
    ...
    public void GetDataTypeForStatusCode(
        string expected,
        OpenApiResponses openApiResponses,
        HttpStatusCode httpStatusCode)
    {
    ...
    public void HasSchemaTypeArray(
        bool expected,
        OpenApiResponses openApiResponses)
    {
        // Act
    ...
    public void HasSchemaHttpStatusCodeUsingSystemNet(
        bool expected,
        OpenApiResponses openApiResponses)
    {
        // Act
    ...
    public void HasSchemaHttpStatusCodeUsingAspNetCoreHttp(
        bool expected,
        OpenApiResponses openApiResponses)
    {
        // Act
    ...
    public void IsSchemaTypeArrayForStatusCode(
        bool expected,
        OpenApiResponses openApiResponses,
        HttpStatusCode httpStatusCode)
    {
    ...
    public void IsSchemaTypePaginationForStatusCode(
        bool expected,
        OpenApiResponses openApiResponses,
        HttpStatusCode httpStatusCode)
    {
    ...
    public void IsSchemaTypeProblemDetailsForStatusCode(
        bool expected,
        OpenApiResponses openApiResponses,
        HttpStatusCode httpStatusCode)
    {
    ...
    public void IsSchemaUsingBinaryFormatForOkResponse(
        bool expected,
        OpenApiResponses openApiResponses)
    {
        // Act
