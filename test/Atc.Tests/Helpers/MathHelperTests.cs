...
public class MathHelperTests
{
    ...
    public void PercentageAsInteger(
        int expected,
        double totalValue,
        double value)
    {
    ...
    public void Percentage_Digits_Limit0To100(
        double expected,
        double totalValue,
        double value,
        int digits,
    ...
    public void EnsureDegreesAreBetween0And360(
        double expected,
        double input)
    {
        // Act
