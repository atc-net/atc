...
public class CardinalDirectionTypeHelperTests
{
    ...
    public void GetWhenRotateLeft_RotationNumber(
        CardinalDirectionType expected,
        CardinalDirectionType input,
        CardinalDirectionType cardinalDirectionTypeToInclude,
        int rotationNumber)
    ...
    public void GetWhenRotateRight(
        CardinalDirectionType expected,
        CardinalDirectionType input,
        CardinalDirectionType cardinalDirectionTypeToInclude)
    ...
    public void GetWhenRotateRight_RotationNumber(
        CardinalDirectionType expected,
        CardinalDirectionType input,
        CardinalDirectionType cardinalDirectionTypeToInclude,
        int rotationNumber)
    ...
    public void GetTheClosestByAngle(
        CardinalDirectionType expected,
        CardinalDirectionType input,
        double angle)
    ...
    public void GetByRotationNumberClockwiseUsingMedium(
        CardinalDirectionType expected,
        int input)
    ...
    public void GetTargetCardinalDirectionByGridCells(
        CardinalDirectionType expected,
        int sourceX,
        int sourceY,
        int targetX,
    ...
    [InlineData(CardinalDirectionType.NorthEast, 0, 1, 1, 0)]
    [InlineData(CardinalDirectionType.SouthWest, 1, 0, 0, 1)]
    public void GetTargetCardinalDirectionByPoint2Ds(
        CardinalDirectionType expected,
        int sourceX,
        int sourceY,
        int targetX,
