...
{
    public class ConflictResultAssertionsTests
    {
        [Fact]
        ...
        public void WithContent_Throws_When_Content_Is_Not_Equivalent_To_Expected()
        {
            ...
            sut.Invoking(x => x.WithContent("BAR"))
                ...
                .WithMessage(@"Expected conflict result to be ""BAR"", but ""FOO"" differs near ""FOO"" (index 0).");
        }
        ...
        public void WithContent_Throws_When_Content_Is_Not_Equivalent_To_Expected_WithBecauseMessage()
        {
            ...
            sut.Invoking(x => x.WithContent("BAR", "Because of something"))
                .Should()
                .Throw<XunitException>()
                .WithMessage(@"Expected conflict result to be ""BAR"" Because of something, but ""FOO"" differs near ""FOO"" (index 0).");
        }
        ...
        public void WithContent_Throws_When_ContentTypes_Isnt_Json()
        {
            ...
            sut.Invoking(x => x.WithContent("FOO"))
                .Should()
                .Throw<XunitException>()
                .WithMessage(@"Expected conflict result to be ""application/json"" with a length of 16, but ""BAZ"" has a length of 3, differs near ""BAZ"" (index 0).");
        }
        ...
        public void WithErrorMessage_Throws_When_Content_Doenst_Match_Expected(string content)
        {
            ...
            sut.Invoking(x => x.WithErrorMessage("BAR"))
                .Should()
                .Throw<XunitException>()
                .WithMessage(@"Expected error message of ""conflict result"" to be ""BAR"", but ""FOO"" differs near ""FOO"" (index 0).");
        }
