...
- [FileHelper](Atc.Helpers.md#filehelper)
  ...
  -  Static Methods
     ...
     - WriteModelToJsonFile(FileInfo fileInfo, T model, JsonSerializerOptions serializeOptions)
     - WriteModelToJsonFile(Stream utf8Json, T model)
     - WriteModelToJsonFile(Stream utf8Json, T model, JsonSerializerOptions serializeOptions)
     - WriteModelToJsonFileAsync(FileInfo fileInfo, T model, CancellationToken cancellationToken = null)
     - WriteModelToJsonFileAsync(FileInfo fileInfo, T model, JsonSerializerOptions serializeOptions, CancellationToken cancellationToken = null)
     - WriteModelToJsonFileAsync(Stream utf8Json, T model, CancellationToken cancellationToken = null)
     - WriteModelToJsonFileAsync(Stream utf8Json, T model, JsonSerializerOptions serializeOptions, CancellationToken cancellationToken = null)
- [FileHelper&lt;T&gt;](Atc.Helpers.md#filehelper&lt;t&gt;)
  -  Static Methods
     - ReadJsonFileToModel(FileInfo fileInfo)
     - ReadJsonFileToModel(FileInfo fileInfo, JsonSerializerOptions serializeOptions)
     - ReadJsonFileToModel(Stream utf8Json)
     - ReadJsonFileToModel(Stream utf8Json, JsonSerializerOptions serializeOptions)
     - ReadJsonFileToModelAsync(FileInfo fileInfo, CancellationToken cancellationToken = null)
     - ReadJsonFileToModelAsync(FileInfo fileInfo, JsonSerializerOptions serializeOptions, CancellationToken cancellationToken = null)
     - ReadJsonFileToModelAsync(Stream utf8Json, CancellationToken cancellationToken = null)
     - ReadJsonFileToModelAsync(Stream utf8Json, JsonSerializerOptions serializeOptions, CancellationToken cancellationToken = null)
     - WriteModelToJsonFile(FileInfo fileInfo, T model)
     - WriteModelToJsonFile(FileInfo fileInfo, T model, JsonSerializerOptions serializeOptions)
     - WriteModelToJsonFile(Stream utf8Json, T model)
     - WriteModelToJsonFile(Stream utf8Json, T model, JsonSerializerOptions serializeOptions)
...
- [NumberHelper](Atc.Helpers.md#numberhelper)
  -  Static Methods
     ...
     - IsDecimal(string value, CultureInfo cultureInfo)
     - IsDecimal(string value, bool useUiCulture)
     - IsDouble(string value)
     - IsDouble(string value, CultureInfo cultureInfo)
     - IsDouble(string value, bool useUiCulture)
     - IsFloat(string value)
     - IsFloat(string value, CultureInfo cultureInfo)
     - IsFloat(string value, bool useUiCulture)
     - IsInt(string value)
     - IsNumber(string value)
     - IsNumber(string value, CultureInfo cultureInfo)
     - IsNumber(string value, bool useUiCulture)
     - ParseToDecimal(string value)
     - ParseToDecimal(string value, CultureInfo cultureInfo)
     - ParseToDecimal(string value, bool useUiCulture)
     - ParseToDouble(string value)
     - ParseToDouble(string value, CultureInfo cultureInfo)
     - ParseToDouble(string value, bool useUiCulture)
     - ParseToFloat(string value)
     - ParseToFloat(string value, CultureInfo cultureInfo)
     - ParseToFloat(string value, bool useUiCulture)
     - ParseToInt(string value)
     - TryParseToDecimal(string value, CultureInfo cultureInfo, out decimal result)
     - TryParseToDecimal(string value, bool useUiCulture, out decimal result)
     - TryParseToDecimal(string value, out decimal result)
     - TryParseToDouble(string value, CultureInfo cultureInfo, out double result)
     - TryParseToDouble(string value, bool useUiCulture, out double result)
     - TryParseToDouble(string value, out double result)
     - TryParseToFloat(string value, CultureInfo cultureInfo, out float result)
...
- [EnumExtensions](System.md#enumextensions)
  -  Static Methods
     ...
     - IsSet(this T enumeration, T flags)
