...
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects with HTTP status code 202 (Accepted).
...
## AtcRestAwesomeAssertionsAssemblyTypeInitializer
...
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects with HTTP status code 400 (Bad Request).
...
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects with HTTP status code 409 (Conflict).
...
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects.
...
>
><b>Returns:</b> An `AwesomeAssertions.AndConstraint`1` for further assertions.
#### WithStatusCode
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> An `AwesomeAssertions.AndWhichConstraint`2` for further assertions.
#### WithContentOfType
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> An `AwesomeAssertions.AndWhichConstraint`2` for further assertions on the typed content.

<br />

## CreatedResultAssertions
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects with HTTP status code 201 (Created).
...
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects with HTTP status code 403 (Forbidden).
...
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects with HTTP status code 204 (No Content).
...
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ContentResult` objects with HTTP status code 404 (Not Found).
...
## OkResultAssertions
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.OkObjectResult` objects with HTTP status code 200 (OK).
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> An `AwesomeAssertions.AndConstraint`1` for chaining further assertions.

<br />

## ResultAssertions
Provides AwesomeAssertions-style assertions for `Microsoft.AspNetCore.Mvc.ActionResult` objects.
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> An `Atc.Rest.AwesomeAssertions.AcceptedResultAssertions` instance for further assertions.
#### BeBadRequestResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.BadRequestResultAssertions` instance for further assertions.
#### BeConflictResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.ConflictResultAssertions` instance for further assertions.
#### BeContentResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.ContentResultAssertions` instance for further assertions.
#### BeCreatedResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.CreatedResultAssertions` instance for further assertions.
#### BeForbiddenResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.ForbiddenResultAssertions` instance for further assertions.
#### BeNoContentResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.NoContentResultAssertions` instance for further assertions.
#### BeNotFoundResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.NotFoundResultAssertions` instance for further assertions.
#### BeOkResult
>```csharp
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`becauseArgs`&nbsp;&nbsp;-&nbsp;&nbsp;Optional formatting arguments for the  parameter.<br />
>
><b>Returns:</b> An `Atc.Rest.AwesomeAssertions.OkResultAssertions` instance for further assertions.
...
Extensions for AwesomeAssertions that make testing Atc Rest handlers easier.
...
>```
><b>Summary:</b> Returns an `Atc.Rest.AwesomeAssertions.ResultAssertions` object that can be used to assert the current `subject`.
>
><b>Parameters:</b><br>
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`subject`&nbsp;&nbsp;-&nbsp;&nbsp;The subject to assert against.<br />
>
><b>Returns:</b> A `Atc.Rest.AwesomeAssertions.ResultAssertions`.
